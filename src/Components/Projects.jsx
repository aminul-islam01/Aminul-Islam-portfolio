                ...
                <div className='md:flex md:flex-row-reverse gap-10 px-10'>
                    ...
                    <div className='md:w-1/2 text-center p-10'>
                        ...
                        <p>Different user roles admin, instructor, and student, first registration All user roles will be a student then admin can
                           ...
                           <div className=''>
                           <a className='font-bold' href="http://" target="_blank" rel="noopener noreferrer">Live Demo</a>
                            <a className='font-bold flex items-center' href="http://" target="_blank" rel="noopener noreferrer">Client site <FaGithubSquare className="inline-block"></FaGithubSquare></a>
                           </div>
                    </div>
                    </Fade>
                </div>
